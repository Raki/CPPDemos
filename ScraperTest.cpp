...
/*
Below demo is created by following : https://www.scrapingbee.com/blog/web-scraping-c++/
*/
...
std::string request(std::string url)
{
    ...
    if (curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_USERAGENT, "simple web scraper");
...
int main()
{
    std::string url = "https://en.cppreference.com/w/cpp/types/size_t";
    auto res = request(url);
    fmt::print("Scrape res = {}\n",scrape(res));
}
